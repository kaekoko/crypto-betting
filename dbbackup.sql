...
CREATE TABLE `custom_records` (
  ...
  `record_time` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `record_date` date NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `users` (
  ...
  `msisdn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_win` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
-- Dump completed on 2022-07-03 14:50:14
